...
typedef std::vector<std::vector<double, AlignmentAllocator<double, 64>>> dmatrix64;
typedef std::vector<std::vector<double, AlignmentAllocator<double, 32>>> dmatrix32;
